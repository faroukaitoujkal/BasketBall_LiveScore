...
- Create Angular project with ng: `ng new basketball_livescore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`basketball_livescore.client.esproj`).
